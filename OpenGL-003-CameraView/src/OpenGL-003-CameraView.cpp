//============================================================================
// Name        : OpenGL-003-CameraView.cpp
// Author      : Naveen Kumar
// Version     :
...
int main() {
	...
	GLuint colorData = glGetUniformLocation(shaderProgram,"colorData");
	...
	while(!glfwWindowShouldClose(window)){
		...
		float colorMix = sin(timeValue)/2.0f + 0.5f;
		glUniform4f(colorData,1.0f,colorMix,0.0f,1.0f);
